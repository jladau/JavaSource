...
public abstract class Region{
	...
	public Region(String sFips, int iStartTime, int iEndTime, HashSet<Integer> setTimes) {
		initialize(sFips, iStartTime, iEndTime, setTimes);
	}
	
	public Region(String sFips, int iStartTime, int iEndTime, ArrayList<Integer> lstTimes){
		initialize(sFips, iStartTime, iEndTime, new HashSet<Integer>(lstTimes));
	}
		
	public Region(Region rgn1) {
