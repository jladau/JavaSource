...
public class State0 extends Region{
	...
	public State0(String sFips, int iStartTime, int iEndTime, ArrayList<Integer> lstTimes){
		super(sFips, iStartTime, iEndTime, lstTimes);
		mapCounties = new HashMap<String,County>(300);
	}

	public State0(String sFips, int iStartTime, int iEndTime, HashSet<Integer> setTimes){
